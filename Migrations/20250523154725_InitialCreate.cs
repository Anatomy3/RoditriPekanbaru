    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 23, 22, 47, 24, 290, DateTimeKind.Local).AddTicks(4795), true, null, "Admin", "Administrator", "admin123", "admin" },
                    { 2, new DateTime(2025, 5, 23, 22, 47, 24, 290, DateTimeKind.Local).AddTicks(4987), true, null, "Penjualan", "Bagian Penjualan", "penjualan123", "penjualan" }
                });
